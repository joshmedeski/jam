...
thumbnail: ./sitting-at-desk.jpeg
---

import WritingInJoural from "./sitting-at-desk.jpeg"
...
<img src={WritingInJoural} alt="Josh writing in a joural" className="rounded-lg shadow-lg md:float-right md:ml-4" />
