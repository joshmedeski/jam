...
import HelpScreen from "./vimium-help-screen.jpg"
import VimiumF from "./vimium-f-command.jpg"
...
<Img src={HelpScreen} alt="Help Screen" />
...
<Img src={VimiumF} alt="Vimium 'f' function" />
