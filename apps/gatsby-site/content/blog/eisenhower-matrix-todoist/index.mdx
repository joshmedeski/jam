...
import Diagram from "./the-eisenhower-matrix-diagram.png"
import ColorCoatedDiagram from "./the-eisenhower-matrix-diagram-color-coated.jpg"
...
<img src={Diagram} alt="Diagram of Eisenhower Matrix" />
...
<img src={ColorCoatedDiagram} alt="Diagram of Eisenhower Matrix" className="rounded-lg shadow-lg" />
