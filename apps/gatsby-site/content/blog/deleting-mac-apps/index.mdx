...
import AppCleanerScreenshot from "./app-cleaner-screenshot.png"
import AlfredUninstallAction from "./alfred-uninstall-action.png"
import AppCleanerCandybarScreenshot from "./app-cleaner-candybar-screenshot.png"
...
<img src={AppCleanerScreenshot} alt="Josh writing in a joural" className="md:float-right md:ml-4" />
...
<img src={AlfredUninstallAction} alt="Alfred uninstall action" />

### 2. Delete the files in AppCleaner

<img src={AppCleanerCandybarScreenshot} alt="Alfred uninstall action" className="md:float-right md:ml-4" />
