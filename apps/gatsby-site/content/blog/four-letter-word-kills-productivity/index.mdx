...
import LaptopOnDesk from "./photo-of-laptop-on-desk.jpg"
import HandOnSteeringWheel from "./photo-of-hand-on-steering-wheel-wearing-a-watch.jpg"
import GreenFrog from "./photo-of-green-frog.jpg"
...
<img src={LaptopOnDesk} alt="Closed latop sitting on hotel desk" className="shadow-lg rounded-lg md:float-right md:ml-4" />
...
<img src={HandOnSteeringWheel} alt="Hand on steering wheel" className="shadow-lg rounded-lg md:float-right md:ml-4" />
...
<img src={GreenFrog} alt="Green Frot" className="shadow-lg rounded-lg md:float-right md:ml-4" />
