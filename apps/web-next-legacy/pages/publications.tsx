...
const PublicationsPage: NextPageWithLayout = () => {
  const writingsItems: PublicationType[] = [
    {
      ...
      url: 'https://www.developerdrive.com/how-to-easily-use-google-fonts-with-sass/',
    ...
    },
    {
      ...
      url: 'https://blog.doist.com/your-remote-work-lifestyle-can-be-much-better/',
      publication: 'Ambition & Balance, by Doist'
    },
    {
      title: 'ProTip: Mailbox + Evernote + IFTTT',
      url: 'https://www.lifehack.org/articles/technology/protip-mailbox-evernote-ifttt.html',
      publication: 'Lifehack'
    },
    {
      title: 'Everything You Need To Know About OS X Mavericks',
      url: 'https://www.lifehack.org/articles/technology/everything-you-need-know-about-mavericks.html',
      publication: 'Lifehack'
    },
    {
      title: 'Why Afternoon Procrastination Happens And How To Deal With It',
      url: 'https://www.lifehack.org/articles/productivity/why-afternoon-procrastination-happens-and-how-deal-with.html',
      publication: 'Lifehack'
    },
    {
      title: 'The Beginner’s Guide to Content Management Systems',
      url: 'https://www.lifehack.org/articles/technology/the-beginners-guide-to-content-management-systems.html',
      publication: 'Lifehack'
    },
    {
    ...
    },
    {
      ...
      url: 'https://medium.com/productivity-chat/using-trello-to-find-a-job-724e92ee6635',
      publication: 'Medium',
      date: 'Apr 15, 2014'
    },
    {
      title: 'Quick Tip: Use CodeKit 2.0 for Local WordPress Development',
      url: 'https://webdesign.tutsplus.com/tutorials/quick-tip-use-codekit-20-for-local-wordpress-development--cms-19402',
      publication: 'Tuts+',
      date: 'Jun 17, 2014'
    },
    {
      title: 'An Introduction to the BEM Methodology',
      url: 'https://webdesign.tutsplus.com/articles/an-introduction-to-the-bem-methodology--cms-19403',
      publication: 'Tuts+',
      date: 'Feb 28, 2014'
    },
    {
      title: 'Simple Visual Enhancements for Better Coding in Sublime Text',
      url: 'https://webdesign.tutsplus.com/articles/simple-visual-enhancements-for-better-coding-in-sublime-text--webdesign-18052?ec_unit=translation-info-language',
      publication: 'Tuts+',
      date: 'Feb 3, 2014'
    },
    {
      title: 'Turbo-Charge Your CSS With Emmet',
      url: 'https://webdesign.tutsplus.com/articles/turbo-charge-your-css-with-emmet--webdesign-16511',
      publication: 'Tuts+',
      date: 'Dec 16, 2013'
    },
    {
      title: 'What Do Entry-Level Software Engineers Do?',
      url: 'https://www.digitalcrafts.com/blog/what-do-entry-level-software-engineers-do',
  ...
  const featuredItems: PublicationType[] = [
    ...
    },
    {
      ...
      url: 'https://blog.trello.com/using-trello-for-a-job-search-less-stress-more-process',
      publication: 'Trello',
      date: 'Nov 06, 2014'
    },
    {
    ...
    },
    {
      ...
      url: 'http://freelancetofreedomproject.com/freelancer-spotlight-josh-medeski/',
    ...
    },
    {
      ...
      url: 'https://www.lifehack.org/articles/productivity/what-your-favorite-productivity-tool.html',
      publication: 'Lifehack'
    },
    {
    ...
    <>
      ...
      <div className="mx-4 my-6 sm:my-12">
        <div className="mx-auto prose prose-sm sm:prose lg:prose-lg xl:prose-xl dark:prose-dark">
          <Img
            alt="quote from josh"
            src="/images/josh-freelance-to-freedom-quote.png"
          ...
          <p>
            ...
            is a podcast I made with my buddy John talking about productivity
            and technology.
          </p>
        </div>
      </div>
...
PublicationsPage.metaData = {
  title: 'Publications',
  description: "Here's a collection of my writings from across the web."
}
